...
public class ObjEntityViewField {
  ...
  private ObjEntityView owner = null;
  ...
  private ObjAttribute objAttribute = null;
  private ObjRelationship objRelationship = null;
  ...
  public Object toRawValue(Object value) {
    ...
    try {
      ...
      v = rootOwner.getDataTypeSpec().fromDataType(
          untypedValueClass, dataType, value);
    }
  ...
  public boolean isSameObjAttribute(ObjEntityViewField field) {
    if (objAttribute != null) {
      ...
      boolean same = (objAttribute.equals(fieldAttribute) ||
                      (objAttribute.getParent().equals(fieldAttribute.getParent()) &&
                      objAttribute.getName().equals(fieldAttribute.getName())));
      return same;
    } else if (isLookup()) {
      if (field.isLookup())
